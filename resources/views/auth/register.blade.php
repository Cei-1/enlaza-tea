...
@section('content')
    ...
    <main class="main-content  mt-0">
        <div class="page-header align-items-start min-vh-50 pt-5 pb-11 m-3 border-radius-lg"
            style="background-image: url('/img/portada.jpg'); background-position: top;">
                    ...
                    <div class="card z-index-0">
                        ...
                        <div class="card-body">
                            <form method="POST" action="{{ route('register.perform') }}">
                                ...
                                <div class="flex flex-col mb-3">
                                <div class="form-group{{ $errors->has('tipoUsuario') ? ' has-danger' : '' }}">
                                        <div class="input-group input-group-alternative">                                          
                                            <select name="tipoUsuario" class="form-control{{ $errors->has('tipoUsuario') ? ' is-invalid' : '' }}">
                                                <option selected disabled>Selecionar usuario</option>
                                                <option class="form-control" value="0">Familiar</option>
                                                <option class="form-control" value="1">Especialista</option>
                                            </select>
                                        </div>
